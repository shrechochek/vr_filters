...
public class AntiGreen extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(AntiGreen.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, AntiGreen.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        pixels[i] = 0xff000000 | r << 16 | 1 << 8 | b;//test
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(AntiGreen.this, cameraSelector, imageAnalysis);
