...
public class Vflip extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Vflip.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Vflip.this);
...
//                                            bitmap.getWidth(), bitmap.getHeight());//test
                    ...
                    cameraProvider.bindToLifecycle(Vflip.this, cameraSelector, imageAnalysis);
