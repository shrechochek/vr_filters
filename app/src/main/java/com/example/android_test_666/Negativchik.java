...
public class Negativchik extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Negativchik.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Negativchik.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        pixels[i] = 0xff000000 | 255-r << 16 | 255-g << 8 | 255-b;//test
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(Negativchik.this, cameraSelector, imageAnalysis);
