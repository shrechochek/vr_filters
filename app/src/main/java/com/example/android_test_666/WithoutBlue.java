...
public class WithoutBlue extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(WithoutBlue.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, WithoutBlue.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        pixels[i] = 0xff000000 | r << 16 | g << 8 | gray;//test
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(WithoutBlue.this, cameraSelector, imageAnalysis);
