...
public class Hflip extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Hflip.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Hflip.this);
...
//                                            bitmap.getWidth(), bitmap.getHeight());//test
                    ...
                    cameraProvider.bindToLifecycle(Hflip.this, cameraSelector, imageAnalysis);
