...
public class Negativ extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Negativ.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Negativ.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        pixels[i] = 0xff000000 | 256-r << 16 | 256-g << 8 | 256-b;//test
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(Negativ.this, cameraSelector, imageAnalysis);
