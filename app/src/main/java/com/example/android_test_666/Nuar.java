...
public class Nuar extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Nuar.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Nuar.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        if (gray > 128){
                                            pixels[i] = 0xff000000 | 255 << 16 | 255 << 8 | 255;//test
                                        } else {
                                            pixels[i] = 0xff000000 | 1 << 16 | 1 << 8 | 1;//test
                                        }
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(Nuar.this, cameraSelector, imageAnalysis);
