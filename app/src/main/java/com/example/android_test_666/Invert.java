        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Invert.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Invert.this);
...
//test
                                    for (int i = 0; i < size; i++) {//test
                                        ...
                                        pixels[i] = 0xff000000 | -r << 16 | -g << 8 | -b;//test
                                    }//test
                    ...
                    cameraProvider.bindToLifecycle(Invert.this, cameraSelector, imageAnalysis);
