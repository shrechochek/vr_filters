        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(Alcohol.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, Alcohol.this);
...
//                                        pixels[i] = 0xff000000 | r << 16 | gray << 8 | b;//test
//                                    }//test
//                                    bitmap.setPixels(pixels, 0, bitmap.getWidth(), 0, 0,//test
//                                            bitmap.getWidth(), bitmap.getHeight());//test

                                    preview.setRotation(angle); //image.getImageInfo().getRotationDegrees()
                                    //angle2++; //test
                    ...
                    cameraProvider.bindToLifecycle(Alcohol.this, cameraSelector, imageAnalysis);
...
//                                            bitmap.getWidth(), bitmap.getHeight());//test
                                    ...
                                    preview2.setRotation(angle); //image.getImageInfo().getRotationDegrees()
                                    angle++;
                                    //angle++; //test
