...
public class WithoutGreen extends AppCompatActivity {
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    imageAnalysis.setAnalyzer(ContextCompat.getMainExecutor(WithoutGreen.this),
                            new ImageAnalysis.Analyzer() {
                                ...
                                public void analyze(@NonNull ImageProxy image) {
                                    ...
                                    Bitmap bitmap = translator.translateYUV(img, WithoutGreen.this);
...
//test
                    ...
                    cameraProvider.bindToLifecycle(WithoutGreen.this, cameraSelector, imageAnalysis);
